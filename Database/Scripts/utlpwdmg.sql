...
BEGIN 
   ...
   -- Check if the password contains at least 3 kinds of uppercase, lowercase, digital and special char.
   ...
   -- 2. Check for the upper case character
   <<findupper>>
   isupper:=FALSE;
   ...
   if charkind<3 then
	raise_application_error(-20007, 'MUST contains at least 3 kinds of uppercase, lowercase, digital and special chars');
   end if;
